...
namespace ISetT_Tests
{
    ...
    public class ISetT_Tests
    {
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Set_IntersectWithException()
        {
            var initialCapacity = 10;
            var set = new Set<int>(initialCapacity);
            set.Add(3);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Set_IsProperSubsetOfException()
        {
            var initialCapacity = 10;
            var set = new Set<int>(initialCapacity);
            set.Add(3);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Set_IsSubsetOfException()
        {
            var initialCapacity = 10;
            var set = new Set<int>(initialCapacity);
            set.Add(3);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Set_IsSupersetOfException()
        {
            var initialCapacity = 10;
            var set = new Set<int>(initialCapacity);
            set.Add(3);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Set_SetEqualsException()
        {
            var initialCapacity = 10;
            var set = new Set<int>(initialCapacity);
            set.Add(3);
        ...
        [TestMethod]
        [ExpectedException(typeof(ArgumentNullException))]
        public void Set_SymmetricExceptWithException()
        {
            var initialCapacity = 10;
            var set = new Set<int>(initialCapacity);
            set.Add(3);
